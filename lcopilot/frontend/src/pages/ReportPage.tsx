        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <p style={{ fontSize: '0.875rem', color: '#6b7280' }}>
              {session?.document?.filename || 'LC Document'}
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <p style={{ fontSize: '0.875rem', color: '#6b7280' }}>
              {session?.createdAt ? new Date(session.createdAt).toLocaleDateString() : 'Today'}
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '1rem' }}>
              {['dates', 'amounts', 'parties', 'ports'].map(category => {
                const count = session.discrepancies.filter(d => d.category === category).length
                return (
